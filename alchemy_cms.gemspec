...
Gem::Specification.new do |gem|
  ...
  gem.add_runtime_dependency 'actionpack-page_caching',          ['>= 1.0.0', '<= 1.1.0']
  ...
  gem.add_runtime_dependency 'awesome_nested_set',               ['~> 3.1.4']
  ...
  gem.add_runtime_dependency 'magiclabs-userstamp',              ['~> 3']
  gem.add_runtime_dependency 'non-stupid-digest-assets',         ['~> 1.0.8']
  gem.add_runtime_dependency 'rails',                            ['>= 4.2.0', '< 6.0']
  ...
  gem.add_runtime_dependency 'turbolinks',                       ['>= 2.5', '< 6.0']
